...
export default function StockJournalVoucher() {
    ...
    const fetchAllVouchers = () => {
        axiosInstance.get('/voucher/sales-order-voucher/').then((response) => {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values, { setErrors }) => {
            ...
            try {
                await axiosInstance.post('/voucher/sales-order-voucher/', request_data)
                fetchAllVouchers()
    ...
    return (
        <MainCard title="Sales Order Vouchers">
